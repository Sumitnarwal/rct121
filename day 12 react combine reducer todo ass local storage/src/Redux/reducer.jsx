import { ADD_TODO, ADD_TODOS_FAILURE, ADD_TODOS_REQUEST, ADD_TODOS_SUCCESS, GET_TODOS_FAILURE, GET_TODOS_REQUEST, GET_TODOS_SUCCESS } from "./actionType";
...
export const reducer = (store = initstate, { type, payload }) => {
    switch (type) {
        ...
        //   const value= {store.(...todos) +payload}
          //  localStorage.setItem("todos",Array(value))
